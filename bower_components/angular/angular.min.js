...
var app=angular.module("personalWebsiteApp",["ngAnimate","ngSanitize"]);app.config(["$locationProvider",function(e){e.html5Mode(!0)}]),app.directive("mainContainer",function(){return{restrict:"EC",transclude:!0,template:'<div ng-include="views"></div>'}}),app.directive("fullWidthContainer",function(){return{restrict:"C",transclude:!0,template:'<div class="single-info-container slide-top" ng-if="itemone" ng-transclude></div>'}}),app.directive("leftSideContainer",function(){return{restrict:"C",transclude:!0,template:'<div class="col-md-8 slide-top" ng-if="itemone" ng-transclude></div>'}}),app.directive("rightSideContainer",function(){return{restrict:"C",transclude:!0,template:'<div class="col-md-4 slide-top" ng-if="itemtwo" ng-transclude></div>'}}),app.directive("fabClose",["$timeout",function(e){return{restrict:"C",template:'<div class="accent close-button slide-top" ng-click="closeItem()" ng-if="fabBtn"></div>',link:function(t){t.fabBtn=!1,e(function(){return t.fabBtn=!0},650)}}}]),app.directive("infoItems",["$rootScope","$timeout",function(e,t){return{restrict:"C",transclude:!0,template:'<ng-transclude ng-click="dataLoad()"></ng-transclude>',link:function(n,o,i){o.on("click",function(){t(function(){e.loadDatas=i.path},200)})}}}]),app.directive("navHome",["$rootScope",function(e){return{restrict:"C",link:function(t,n,o){e.views=o.path}}}]),app.directive("personalMap",["$rootScope","$sce",function(e,t){return{restrict:"C",transclude:!0,template:'<iframe frameborder="0" style="border:0" ng-src="{{theURL()}}" allowfullscreen></iframe>',link:function(e,n,o){e.latitude=o.latitude,e.longitude=o.longitude,e.api=o.api,e.zoom=o.zoom,e.zoomNum=function(e){return e>15?15:0>e?0:e},e.theUrl="https://www.google.com/maps/embed/v1/place?q=",e.theUL=t.trustAsResourceUrl(e.theUrl),e.theURL=function(){return t.trustAsResourceUrl(e.theUL+e.latitude+"%2C"+e.longitude+"&key="+e.api+"&zoom="+e.zoomNum(e.zoom))}}}}]),app.directive("loadData",["$rootScope","$timeout","$location",function(e,t,n){return{restrict:"C",transclude:!0,template:'<div ng-click="closeMenu()" ng-transclude></div>',link:function(o,i,r){i.on("click",function(){n.path("/").hash(""),o.loader=!0,t(function(){o.loader=!1},600),e.menu=!1,e.views=r.path,o.itemone=!1,t(function(){o.itemone=!0},250),o.itemtwo=!1,t(function(){o.itemtwo=!0},450),o.$apply()})}}}]),app.directive("loadingItems",["$rootScope","$location","$anchorScroll",function(e,t,n){return{restrict:"C",transclude:!0,template:'<div ng-click="dataLoad()" ng-transclude></div>',link:function(o,i,r){i.on("click",function(){e.menu=!0,e.loadViews=r.path,t.hash("theMain"),n()})}}}]),app.controller("personalWebsiteAppController",["$scope","$rootScope","$timeout","$location","$anchorScroll",function(e,t,n,o){e.colorContainer=!1,e.openColorChanger=function(){return e.colorContainer=!e.colorContainer},t.colors="css/blue.css",e.changeColor=function(e){t.colors=e},t.menu=!1,e.dataLoad=function(){e.loader=!0,n(function(){e.loader=!1},600)},e.closeMenu=function(){r.addClass("closeMobileMenu"),r.removeClass("openMobileMenu")};var i=angular.element(document.querySelector(".loads"));e.loader=!0,n(function(){i.css({height:"220px","z-index":0,opacity:0}),e.loader=!1},600);var r=angular.element(document.querySelector(".left-side"));e.openMenu=function(){r.addClass("openMobileMenu"),r.removeClass("closeMobileMenu")},e.closeItem=function(){t.menu=!1,o.path("/").hash("")},t.blog=!0,e.itemone=!1,n(function(){e.itemone=!0},250),e.itemtwo=!1,n(function(){e.itemtwo=!0},450),e.loadCont=function(i){o.path("/").hash(""),e.loader=!0,n(function(){e.loader=!1},600),t.menu=!1,t.views=i,e.itemone=!1,n(function(){e.itemone=!0},250),e.itemtwo=!1,n(function(){e.itemtwo=!0},450),console.log(i)}}]),app.directive("skillProgress",["$rootScope",function(){return{scope:{},restrict:"C",template:'<div class="skillss"><h3><ng-transclude></ng-transclude></h3><div class="progres"><div class="primary determinate" ng-style="{\'width\' : progressPersentages}"><i class="fa primary-font fa-circle"></i></div></div></div>',transclude:!0,link:function(e,t,n){var o=n.progressPersentage;e.progressPersentages=o,e.$apply}}}]);
